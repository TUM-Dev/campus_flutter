...
class AverageGrade {
  ...
  @JsonKey(name: "avg_grade_weighted_by_credits", fromJson: StringParser.stringToDouble)
  ...
  factory AverageGrade.fromJson(Map<String, dynamic> json) => _$AverageGradeFromJson(json);
...
class AverageGradeResponse {
  ...
  AverageGradeResponse({
    required this.averageGradeData
  });

  factory AverageGradeResponse.fromJson(Map<String, dynamic> json) => _$AverageGradeResponseFromJson(json);
...
class AverageGrades {
  ...
  factory AverageGrades.fromJson(Map<String, dynamic> json) => _$AverageGradesFromJson(json);
