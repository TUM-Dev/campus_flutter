...
class ErrorHandlingView extends StatelessWidget {
  const ErrorHandlingView(
      {super.key, required this.error, required this.errorHandlingViewType, required this.retry});
  ...
  Widget _exceptionMessage(BuildContext context, String errorMessage, String? fixMessage) {
              ...
              mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  ...
                  Image.asset("assets/images/errors/error_square.png",
                      height: MediaQuery.of(context).size.height * 0.3333, fit: BoxFit.scaleDown),
                  const Spacer(),
                  Expanded(flex: 0, child: Column(children: [
                    ...
                    if (fixMessage != null) Text(fixMessage,
                  ...
                  const Spacer(),
                  ElevatedButton(onPressed: () => retry(true), child: const Text("Try Again")),
                  const Spacer()
                ]));
...
enum ErrorHandlingViewType { fullScreen, textOnly, descriptionOnly, redDescriptionOnly }
