...
class CampusClient extends $grpc.Client {
  static final _$listNewsAlerts =
      $grpc.ClientMethod<$0.ListNewsAlertsRequest, $0.ListNewsAlertsReply>(
          ...
          ($core.List<$core.int> value) =>
              $0.ListNewsAlertsReply.fromBuffer(value));
  static final _$listNewsSources =
      $grpc.ClientMethod<$0.ListNewsSourcesRequest, $0.ListNewsSourcesReply>(
          ...
          ($core.List<$core.int> value) =>
              $0.ListNewsSourcesReply.fromBuffer(value));
  ...
  static final _$searchRooms =
      $grpc.ClientMethod<$0.SearchRoomsRequest, $0.SearchRoomsReply>(
          '/api.Campus/SearchRooms',
          ($0.SearchRoomsRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.SearchRoomsReply.fromBuffer(value));
  static final _$listCanteenRatings = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) =>
          $0.ListCanteenRatingsReply.fromBuffer(value));
  static final _$getDishRatings =
      $grpc.ClientMethod<$0.GetDishRatingsRequest, $0.GetDishRatingsReply>(
          ...
          ($core.List<$core.int> value) =>
              $0.GetDishRatingsReply.fromBuffer(value));
  static final _$createCanteenRating = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) =>
          $0.CreateCanteenRatingReply.fromBuffer(value));
  static final _$createDishRating =
      $grpc.ClientMethod<$0.CreateDishRatingRequest, $0.CreateDishRatingReply>(
          ...
          ($core.List<$core.int> value) =>
              $0.CreateDishRatingReply.fromBuffer(value));
  static final _$listAvailableDishTags = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) =>
          $0.ListAvailableDishTagsReply.fromBuffer(value));
  static final _$listNameTags =
      $grpc.ClientMethod<$0.ListNameTagsRequest, $0.ListNameTagsReply>(
          ...
          ($core.List<$core.int> value) =>
              $0.ListNameTagsReply.fromBuffer(value));
  static final _$listAvailableCanteenTags = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) =>
          $0.ListAvailableCanteenTagsReply.fromBuffer(value));
  static final _$listCanteens =
      $grpc.ClientMethod<$0.ListCanteensRequest, $0.ListCanteensReply>(
          ...
          ($core.List<$core.int> value) =>
              $0.ListCanteensReply.fromBuffer(value));
  static final _$listDishes =
      $grpc.ClientMethod<$0.ListDishesRequest, $0.ListDishesReply>(
          ...
          ($core.List<$core.int> value) =>
              $0.ListDishesReply.fromBuffer(value));
  static final _$listResponsiblePerson = $grpc.ClientMethod<
          $0.ListResponsiblePersonRequest, $0.ListResponsiblePersonReply>(
      '/api.Campus/ListResponsiblePerson',
      ($0.ListResponsiblePersonRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $0.ListResponsiblePersonReply.fromBuffer(value));
  static final _$listMoreInformation = $grpc.ClientMethod<
          $0.ListMoreInformationRequest, $0.ListMoreInformationReply>(
      '/api.Campus/ListMoreInformation',
      ($0.ListMoreInformationRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $0.ListMoreInformationReply.fromBuffer(value));
  static final _$listOpeningTimes =
      $grpc.ClientMethod<$0.ListOpeningTimesRequest, $0.ListOpeningTimesReply>(
          '/api.Campus/ListOpeningTimes',
          ($0.ListOpeningTimesRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.ListOpeningTimesReply.fromBuffer(value));
  static final _$getUpdateNote =
      $grpc.ClientMethod<$0.GetUpdateNoteRequest, $0.GetUpdateNoteReply>(
          ...
          ($core.List<$core.int> value) =>
              $0.GetUpdateNoteReply.fromBuffer(value));
  static final _$listStudyRooms =
      $grpc.ClientMethod<$0.ListStudyRoomsRequest, $0.ListStudyRoomsReply>(
          '/api.Campus/ListStudyRooms',
          ($0.ListStudyRoomsRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.ListStudyRoomsReply.fromBuffer(value));
  static final _$listMovies =
      $grpc.ClientMethod<$0.ListMoviesRequest, $0.ListMoviesReply>(
          ...
          ($core.List<$core.int> value) =>
              $0.ListMoviesReply.fromBuffer(value));
  static final _$createFeedback =
      $grpc.ClientMethod<$0.CreateFeedbackRequest, $0.CreateFeedbackReply>(
          ...
          ($core.List<$core.int> value) =>
              $0.CreateFeedbackReply.fromBuffer(value));
  static final _$getUploadStatus =
      $grpc.ClientMethod<$0.GetUploadStatusRequest, $0.GetUploadStatusReply>(
          ...
          ($core.List<$core.int> value) =>
              $0.GetUploadStatusReply.fromBuffer(value));
  static final _$getNotification =
      $grpc.ClientMethod<$0.GetNotificationRequest, $0.GetNotificationReply>(
          '/api.Campus/GetNotification',
          ($0.GetNotificationRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.GetNotificationReply.fromBuffer(value));
  static final _$getNotificationConfirm = $grpc.ClientMethod<
          $0.GetNotificationConfirmRequest, $0.GetNotificationConfirmReply>(
      '/api.Campus/GetNotificationConfirm',
      ($0.GetNotificationConfirmRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $0.GetNotificationConfirmReply.fromBuffer(value));
  static final _$getMember =
      $grpc.ClientMethod<$0.GetMemberRequest, $0.GetMemberReply>(
  ...
  static final _$getCanteenHeadCount = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) =>
          $0.GetCanteenHeadCountReply.fromBuffer(value));
  static final _$iOSDeviceRequestResponse = $grpc.ClientMethod<
          $0.IOSDeviceRequestResponseRequest, $0.IOSDeviceRequestResponseReply>(
      '/api.Campus/IOSDeviceRequestResponse',
      ($0.IOSDeviceRequestResponseRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $0.IOSDeviceRequestResponseReply.fromBuffer(value));
  ...
  static final _$deleteDevice =
      $grpc.ClientMethod<$0.DeleteDeviceRequest, $0.DeleteDeviceReply>(
          ...
          ($core.List<$core.int> value) =>
              $0.DeleteDeviceReply.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.ListNewsReply> listNews($0.ListNewsRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$listNews, request, options: options);
  }

  $grpc.ResponseFuture<$0.SearchRoomsReply> searchRooms(
      $0.SearchRoomsRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.ListAvailableCanteenTagsReply>
      listAvailableCanteenTags($0.ListAvailableCanteenTagsRequest request,
          {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.ListResponsiblePersonReply> listResponsiblePerson(
      $0.ListResponsiblePersonRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$listResponsiblePerson, request, options: options);
  }

  $grpc.ResponseFuture<$0.ListMoreInformationReply> listMoreInformation(
      $0.ListMoreInformationRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$listMoreInformation, request, options: options);
  }

  $grpc.ResponseFuture<$0.ListOpeningTimesReply> listOpeningTimes(
      $0.ListOpeningTimesRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.ListStudyRoomsReply> listStudyRooms(
      $0.ListStudyRoomsRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.GetUploadStatusReply> getUploadStatus(
      $0.GetUploadStatusRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getUploadStatus, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetNotificationReply> getNotification(
      $0.GetNotificationRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getNotification, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetNotificationConfirmReply> getNotificationConfirm(
      $0.GetNotificationConfirmRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getNotificationConfirm, request,
        options: options);
  }

  $grpc.ResponseFuture<$0.GetMemberReply> getMember($0.GetMemberRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.IOSDeviceRequestResponseReply>
      iOSDeviceRequestResponse($0.IOSDeviceRequestResponseRequest request,
          {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$iOSDeviceRequestResponse, request,
        options: options);
  }
...
abstract class CampusServiceBase extends $grpc.Service {
  ...
  CampusServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.SearchRoomsRequest, $0.SearchRoomsReply>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.SearchRoomsRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.ListResponsiblePersonRequest,
            $0.ListResponsiblePersonReply>(
        'ListResponsiblePerson',
        listResponsiblePerson_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.ListResponsiblePersonRequest.fromBuffer(value),
        ($0.ListResponsiblePersonReply value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.ListMoreInformationRequest,
            $0.ListMoreInformationReply>(
        'ListMoreInformation',
        listMoreInformation_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.ListMoreInformationRequest.fromBuffer(value),
        ($0.ListMoreInformationReply value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.ListOpeningTimesRequest,
            $0.ListOpeningTimesReply>(
        'ListOpeningTimes',
        listOpeningTimes_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.ListOpeningTimesRequest.fromBuffer(value),
    ...
    $addMethod(
        $grpc.ServiceMethod<$0.ListStudyRoomsRequest, $0.ListStudyRoomsReply>(
            'ListStudyRooms',
            listStudyRooms_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $0.ListStudyRoomsRequest.fromBuffer(value),
    ...
    $addMethod(
        $grpc.ServiceMethod<$0.GetUploadStatusRequest, $0.GetUploadStatusReply>(
            'GetUploadStatus',
            getUploadStatus_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $0.GetUploadStatusRequest.fromBuffer(value),
            ($0.GetUploadStatusReply value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$0.GetNotificationRequest, $0.GetNotificationReply>(
            'GetNotification',
            getNotification_Pre,
            false,
            false,
    ...
    $addMethod($grpc.ServiceMethod<$0.GetNotificationConfirmRequest,
            $0.GetNotificationConfirmReply>(
        'GetNotificationConfirm',
        getNotificationConfirm_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.GetNotificationConfirmRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.IOSDeviceRequestResponseRequest,
            $0.IOSDeviceRequestResponseReply>(
        'IOSDeviceRequestResponse',
        iOSDeviceRequestResponse_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.IOSDeviceRequestResponseRequest.fromBuffer(value),
  ...
  $async.Future<$0.ListNewsReply> listNews_Pre(
      $grpc.ServiceCall call, $async.Future<$0.ListNewsRequest> request) async {
    return listNews(call, await request);
  }

  $async.Future<$0.SearchRoomsReply> searchRooms_Pre($grpc.ServiceCall call,
      $async.Future<$0.SearchRoomsRequest> request) async {
  ...
  $async.Future<$0.ListResponsiblePersonReply> listResponsiblePerson_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.ListResponsiblePersonRequest> request) async {
    return listResponsiblePerson(call, await request);
  }

  $async.Future<$0.ListMoreInformationReply> listMoreInformation_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.ListMoreInformationRequest> request) async {
    return listMoreInformation(call, await request);
  }

  $async.Future<$0.ListOpeningTimesReply> listOpeningTimes_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.ListOpeningTimesRequest> request) async {
    return listOpeningTimes(call, await request);
  }

  $async.Future<$0.GetUpdateNoteReply> getUpdateNote_Pre($grpc.ServiceCall call,
      $async.Future<$0.GetUpdateNoteRequest> request) async {
    return getUpdateNote(call, await request);
  }

  $async.Future<$0.ListStudyRoomsReply> listStudyRooms_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.ListStudyRoomsRequest> request) async {
  ...
  $async.Future<$0.GetUploadStatusReply> getUploadStatus_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.GetUploadStatusRequest> request) async {
    return getUploadStatus(call, await request);
  }

  $async.Future<$0.GetNotificationReply> getNotification_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.GetNotificationRequest> request) async {
    return getNotification(call, await request);
  }

  $async.Future<$0.GetNotificationConfirmReply> getNotificationConfirm_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.GetNotificationConfirmRequest> request) async {
    return getNotificationConfirm(call, await request);
  }

  $async.Future<$0.GetMemberReply> getMember_Pre($grpc.ServiceCall call,
  ...
  $async.Future<$0.IOSDeviceRequestResponseReply> iOSDeviceRequestResponse_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.IOSDeviceRequestResponseRequest> request) async {
  ...
  $async.Future<$0.SearchRoomsReply> searchRooms(
      $grpc.ServiceCall call, $0.SearchRoomsRequest request);
  ...
  $async.Future<$0.ListResponsiblePersonReply> listResponsiblePerson(
      $grpc.ServiceCall call, $0.ListResponsiblePersonRequest request);
  $async.Future<$0.ListMoreInformationReply> listMoreInformation(
      $grpc.ServiceCall call, $0.ListMoreInformationRequest request);
  $async.Future<$0.ListOpeningTimesReply> listOpeningTimes(
      $grpc.ServiceCall call, $0.ListOpeningTimesRequest request);
  $async.Future<$0.GetUpdateNoteReply> getUpdateNote(
      $grpc.ServiceCall call, $0.GetUpdateNoteRequest request);
  $async.Future<$0.ListStudyRoomsReply> listStudyRooms(
      $grpc.ServiceCall call, $0.ListStudyRoomsRequest request);
  ...
  $async.Future<$0.GetUploadStatusReply> getUploadStatus(
      $grpc.ServiceCall call, $0.GetUploadStatusRequest request);
  $async.Future<$0.GetNotificationReply> getNotification(
      $grpc.ServiceCall call, $0.GetNotificationRequest request);
  $async.Future<$0.GetNotificationConfirmReply> getNotificationConfirm(
      $grpc.ServiceCall call, $0.GetNotificationConfirmRequest request);
  $async.Future<$0.GetMemberReply> getMember(
  ...
  $async.Future<$0.IOSDeviceRequestResponseReply> iOSDeviceRequestResponse(
      $grpc.ServiceCall call, $0.IOSDeviceRequestResponseRequest request);
